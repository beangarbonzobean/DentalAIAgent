  ...
  router.post('/work-orders/:id/pdf', async (req: Request, res: Response) => {
    try {
      ...
      const workOrder: CrownWorkOrder = {
        ...
        patient: {
          ...workOrderRecord.lab_slip_data.patient,
          dateOfBirth: new Date(workOrderRecord.lab_slip_data.patient.dateOfBirth)
        },
        procedure: {
          ...workOrderRecord.lab_slip_data.procedure,
          procedureDate: new Date(workOrderRecord.lab_slip_data.procedure.procedureDate)
        },
